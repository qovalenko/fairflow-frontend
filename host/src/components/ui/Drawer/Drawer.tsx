...
const Drawer = (props: DrawerProps) => {
    ...
    const handleRequestClose = (e: MouseEvent | KeyboardEvent) => {
        if (rest.onRequestClose) {
            ...
            onClose?.(e as MouseEvent<HTMLSpanElement>)
        }
    }
    ...
    return (
        <Modal
            ...
            {...rest}
            shouldCloseOnOverlayClick={rest.shouldCloseOnOverlayClick ?? true}
            onRequestClose={rest.onRequestClose ?? handleRequestClose}
        >
            <motion.div

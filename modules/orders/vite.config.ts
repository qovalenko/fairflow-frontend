  ...
  plugins: [
    ...
    federation({
      ...
      exposes: {
        ...
        './DealCreateOrderAction': './src/DealCreateOrderAction.tsx',
        './OrderListActionMenu': './src/OrderListActionMenu.tsx',
        './OrderListBulkActionMenu': './src/OrderListBulkActionMenu.tsx',
      },
      shared: {
  ...
  resolve: {
    alias: [
      ...
      },
      {
        ...
        replacement: path.join(__dirname, '../../../be-r3-ui-shell/shared/src/slot-catalog.ts'),
      },
    ],
  },
  build: {

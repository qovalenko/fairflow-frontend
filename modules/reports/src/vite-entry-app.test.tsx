...
vi.mock('./ReportsModule', () => ({
    default: () => <div>Экран reports</div>,
}))
...
describe('vite-entry-app — standalone bootstrap', () => {
    ...
    it('монтирует ReportsModule через StandaloneModuleApp', async () => {
        ...
        expect(screen.getByText('Экран reports')).toBeInTheDocument()
    })
})

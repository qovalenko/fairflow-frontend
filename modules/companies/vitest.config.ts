/**
 * Companies remote test config — pin hook-bearing deps на host singleton React
 * (host/testing/README-TESTING.md, образец statistics/contacts).
 */
        ...
        load(id: string) {
            return id === '\0stub:shared-ui'
                ? [
                      ...
                      'export function CompanyActivitiesWidget() { return null }',
                  ].join('\n')
                : null
        },
    }
    ...
    test: {
        ...
        coverage: {
            ...
            exclude: [
                ...
                'src/qa.ts',
                'src/qa-env.d.ts',
                'src/views/crm/Companies/index.ts',
                'src/views/crm/Import/CompanyImport.tsx',
            ],
        },
    },
    resolve: {
        ...
        alias: {
            ...
            '@floating-ui/react': fromHost('@floating-ui/react'),

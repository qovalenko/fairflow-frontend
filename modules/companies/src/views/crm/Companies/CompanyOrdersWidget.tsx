...
const CompanyOrdersWidget = ({ orders, onOrderClick, loading = false }: CompanyOrdersWidgetProps) => {
    return (
        <Card
        ...
        >
            <div className="flex-1 flex flex-col min-h-0">
                {loading ? (
                    <div className="flex flex-col gap-3 py-2" {...qa('companies.card.ordersLoading')}>
                        {[1, 2, 3].map((i) => (
                        ...
                        {orders.map((order) => {
                            ...
                            return (
                                <div
                                    ...
                                    {...qa('companies.card.orderRow', { order: order.id })}
                                >

...
export default defineConfig(({ command, mode }) => ({
  ...
  plugins: [
    ...
    federation({
      ...
      exposes: {
        './StatisticsModule': './src/StatisticsModule.tsx',
        './DashboardKpiMount': './src/mount-points/DashboardKpiMount.tsx',
        './DashboardChartsMount': './src/mount-points/DashboardChartsMount.tsx',
        './DashboardListsMount': './src/mount-points/DashboardListsMount.tsx',
      },
      shared: {

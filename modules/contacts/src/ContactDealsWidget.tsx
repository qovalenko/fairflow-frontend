...
export interface ContactDealsWidgetProps {
    deals: Deal[]
    onDealClick?: (deal: Deal) => void
    loading?: boolean
}

const ContactDealsWidget = ({ deals, onDealClick, loading = false }: ContactDealsWidgetProps) => (
    <Card
                ...
                <div className="divide-y divide-gray-200 dark:divide-gray-600">
                    {deals.map((deal) => (
                        <div
                            ...
                            {...qa('contacts.details.dealRow', { deal: deal.id })}
                        >
...
export default ContactDealsWidget
